	...
	function gettable() {
		...
		function initTable() {
			...
			for (var j in tabledata) {
				...
				html += '</tr>'*/
				html += '<tr>'
				html += '<td id="ID" class="entry">' + '<a href="#/dataentry" >' + obj.id + '</a>' + '</td>';
				html += '<td class="entry">' + '<a href="#/dataentry" >' + obj.uname1 + '</a>' + '</td>';
				html += '<td class="entry">' + '<a href="#/dataentry" >' + obj.in_or_out + '</a>' + '</td>';
				html += '<td class="entry">' + '<a href="#/dataentry" >' + obj.uname2 + '</a>' + '</td>';
				html += '<td class="entry">' + '<a href="#/dataentry" >' + obj.amount + '</a>' + '</td>';
				html += '<td class="entry">' + '<a href="#/dataentry" >' + obj.date + '</a>' + '</td>';
				html += '<td class="entry">' + '<a href="#/dataentry" >' + obj.kind + '</a>' + '</td>';
				html += '<td id="check"><input type="checkbox" /></td>';
				html += '</tr>'
			}
			html += '</table>';
